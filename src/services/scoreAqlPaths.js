/**
 * AQL paths for all DV_ORDINAL fields included in the MDS-UPDRS Part III total score
 * (3.1–3.18). The total_score itself is deliberately NOT included here —
 * it is calculated, not entered.
 *
 * Moved to a separate file so that templateParser.js remains concise and focused on the
 * actual parsing logic.
 * 
 * Note: The Code was created with the help of Claude ai
 */
