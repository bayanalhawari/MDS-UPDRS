/**
 * FormField.jsx
 * Renders a single template-driven form field. Each field's RM type (from
 * the openEHR template) is mapped to the right input widget via
 * getWidgetType(), and this file wraps that widget with a shared label,
...
// own explanatory description underneath the label at all times 
// so the examiner can read the scoring criteria while choosing.
